...
# Lab 06
# Lab Section: 12
# Sources, people worked with, help given to: TA, Mak Weinzierl
# your
# comments
# here
...
for numbers in letter_count:
    if letter_count[numbers] == sorted_dict[-1]:
        most_occured = numbers

for numbers in letter_count:
    if letter_count[numbers] == sorted_dict[0]:
        least_occured = numbers
...
for letters in letter_count:
    print(letters,letter_count[letters]/len(random_string)*100)